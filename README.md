...
I’m **Kirti Yogi** (`Kirti Yogi`, reg no `24MIM10188`). I wrote a few small shell scripts to pull basic system info, check package info, audit a couple of directories, and scan a log file for keyword matches.
## What’s inside
...
- `manifesto_Kirti Yogi.txt` - Example output from the manifesto generator
## How to run the scripts
From the repo directory (`/home/Kiriti Yogi/oss-audit-24MIM10188`):
...
2. **Run them:**
   ...
   - `./script5.sh`
      ...
      - It asks 3 questions and writes `manifesto_priyanshukumarsingh.txt`
